# -*- coding: utf-8 -*-
from astronex.compat import Gtk, Gdk, pango, pangocairo
...
class TextArea(Gtk.DrawingArea):
    ...
    def text_for_ascent(self,cr,width):
        ...
        layout.set_text("1  %s" % ascent_texts['a1'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        cr.move_to(0,0)
        pangocairo.show_layout(cr, layout)
        layout.set_text("2  %s" % ascent_texts['a2'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        cr.move_to(0,v)
        pangocairo.show_layout(cr, layout)
        layout.set_text("3  %s" % ascent_texts['a3'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        cr.move_to(0,v*2)
        pangocairo.show_layout(cr, layout)
        layout.set_text("%s" % ascent_texts['a3b'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        cr.move_to(0,v*3)
        pangocairo.show_layout(cr, layout)
        layout.set_text("4  %s" % ascent_texts['a4'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        cr.move_to(0,v*4)
        pangocairo.show_layout(cr, layout)
        layout.set_text("%s" % ascent_texts['a4b'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        cr.move_to(0,v*5)
        pangocairo.show_layout(cr, layout)
        cr.set_source_rgb(*fem_col)
        layout.set_text("5/6  %s" % ascent_texts['a5'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        cr.move_to(0,v*6)
        pangocairo.show_layout(cr, layout)
        layout.set_text("7/8  %s" % ascent_texts['a7'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        cr.move_to(0,v*7)
        pangocairo.show_layout(cr, layout)
    ...
    def text_for_polar(self,cr,width):
        ...
        layout.set_text("6  %s" % polar_texts['P6'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        ...
        layout.set_text("5 %s" % polar_texts['P5'], -1)
        ink,logical = layout.get_extents()
        ...
        layout.set_text("14  %s" % polar_texts['P14'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
        ...
        layout.set_text("9  %s" % polar_texts['P9'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        ...
        layout.set_text("10  %s" % polar_texts['P10'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
        ...
        layout.set_text("13  %s" % polar_texts['P13'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
        ...
        layout.set_text("4  %s" % polar_texts['P4'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        ...
        layout.set_text("3  %s" % polar_texts['P3'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
        ...
        layout.set_text("12  %s" % polar_texts['P12'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
        ...
        layout.set_text("7  %s" % polar_texts['P7'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        ...
        layout.set_text("8  %s" % polar_texts['P8'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
        ...
        layout.set_text("11  %s" % polar_texts['P11'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
        ...
        layout.set_text("2 %s" % polar_texts['P2'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        ...
        layout.set_text("1 %s" % polar_texts['P1'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
    ...
    def text_for_wunder(self,cr,width):
        ...
        layout.set_text("1  %s" % wunder_texts['w1'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        cr.move_to(0,0)
        pangocairo.show_layout(cr, layout)
        layout.set_text("2  %s" % wunder_texts['w2'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        cr.move_to(0,v)
        pangocairo.show_layout(cr, layout)
        layout.set_text("3  %s" % wunder_texts['w3'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        cr.move_to(0,v*2)
        pangocairo.show_layout(cr, layout)
        layout.set_text("4  %s" % wunder_texts['w4'], -1)
        ink,logical = layout.get_extents()
        h = logical.height/pango.SCALE
        cr.move_to(0,v*3)
        pangocairo.show_layout(cr, layout)
        cr.set_source_rgb(*s_col)
        layout.set_text("1  %s" % wunder_texts['s1'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
        cr.move_to(width-mar-w,v*4)
        pangocairo.show_layout(cr, layout)
        layout.set_text("2  %s" % wunder_texts['s2'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
        cr.move_to(width-mar-w,v*5)
        pangocairo.show_layout(cr, layout)
        layout.set_text("3  %s" % wunder_texts['s3'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
        cr.move_to(width-mar-w,v*6)
        pangocairo.show_layout(cr, layout)
        layout.set_text("4  %s" % wunder_texts['s4'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
        cr.move_to(width-mar-w,v*7)
        pangocairo.show_layout(cr, layout)
        layout.set_text("5  %s" % wunder_texts['s5'], -1)
        ink,logical = layout.get_extents()
        w = logical.width/pango.SCALE
        h = logical.height/pango.SCALE
